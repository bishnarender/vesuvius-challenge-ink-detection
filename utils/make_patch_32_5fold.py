# file is similar to make_patch_32.py so read this for code explaination.
...
PREFIX = "vesuvius-challenge-ink-detection-5fold/train"
PATCH_SIZE = 32
...
for data_id in tqdm(data_ids, position=0, leave=True):
    ...
    volume_dir = f"vesuvius_patches_{PATCH_SIZE}_5fold/train/{data_id}/surface_volume/"
    ir_dir = f"vesuvius_patches_{PATCH_SIZE}_5fold/train/{data_id}/ir/"
    mask_dir = f"vesuvius_patches_{PATCH_SIZE}_5fold/train/{data_id}/mask/"
    label_dir = f"vesuvius_patches_{PATCH_SIZE}_5fold/train/{data_id}/label/"
